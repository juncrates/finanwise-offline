...
const seedStore: Store = {
  ...
  cards: [
    { id: "nubank", name: "Nubank Ultravioleta", bank: "Nubank", lastFour: "4821", limit: 8000, color: "graphite" },
    { id: "itau", name: "Itaú Platinum", bank: "Itaú", lastFour: "0918", limit: 5000, color: "navy" },
  ],
  expenses: [
...
export default function Home() {
  ...
  const [cardForm, setCardForm] = useState({ name: "", bank: "", lastFour: "", limit: "" });
  ...
  const openCardEditor = (card: CardData) => {
    ...
    setCardForm({ name: card.name, bank: card.bank, lastFour: card.lastFour, limit: String(card.limit) });
    setModal("editCard");
  };
  ...
  const editCard = (event: React.FormEvent) => {
    ...
    const nextStore = { ...store, cards: store.cards.map((card) => card.id === editingCardId ? { ...card, name: cardForm.name.trim(), bank: cardForm.bank.trim(), lastFour: cardForm.lastFour.slice(-4), limit } : card) };
    persistStore(nextStore);
    setStore(nextStore);
    setModal(null);
  ...
  const addCard = (event: React.FormEvent) => {
    ...
    setCardForm({ name: "", bank: "", lastFour: "", limit: "" });
    setModal(null);
